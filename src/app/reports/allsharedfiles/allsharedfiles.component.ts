...
@Component({
  selector: 'app-allsharedfiles',
  templateUrl: './allsharedfiles.component.html',
  styleUrls: ['./allsharedfiles.component.scss']
})
export class AllsharedfilesComponent implements OnInit {
  ...
  utillist: any;
  messaageslist: any;
  jsonurl = "assets/js/_configs/viewSharedFilesListRpt.json";
  ...
  tablecollist = [
    ...
    { "name": "Shared To", "cname": "SharedToName", "sortable": true },
...
// console.log(dataParam);
  ...
  excelDownloadSharedFilesList() {
    ...
    /* save to file */
    XLSX.writeFile(wb, "Shared-Files-List.xlsx");
  }
}
