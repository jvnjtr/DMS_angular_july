...
@Component({
  selector: 'app-nearretentions',
  templateUrl: './nearretentions.component.html',
  styleUrls: ['./nearretentions.component.scss']
})
export class NearretentionsComponent implements OnInit {
  ...
  utillist: any;
  messaageslist: any;
  jsonurl = "assets/js/_configs/retentionFilesListRpt.json";
  ...
  tablecollist = [
    ...
    { "name": "Retention On", "cname": "archivedDate", "sortable": true }
  ]
  ...
  loadData(type: any, basedon: any, user: any, fromdate: any, todate: any, graphtype: any) {
    ...
    this.loading = true
    this.reportService.rptRetentionFilesList(dataParam).subscribe((response: any) => {
...
console.log(responseResult);
  ...
  excelDownloadRetentionList() {
    ...
    /* save to file */
    XLSX.writeFile(wb, "Retention-Files-List.xlsx");
  }
}
