export const environment = {
  ...
  siteURL: 'http://192.168.10.186/dms_testI/website/',

  //serviceURL: 'http://172.27.30.93:7005/dms_php_admin/admin/',

  serviceURL: 'http://192.168.10.186/dms_testI/admin/',

  pdfiframeURL: 'http://192.168.10.186/dms_testI/pdfjsnew/web/viewer.html',

  iframeURL: 'http://192.168.10.186/dms_testI/office_viewer/demos.html',

  iframeviewURL: 'http://192.168.10.186/dms_testI/office_viewer/demos-preview.html',

  excelViewer: 'http://192.168.10.186/dms_testI/office-xlsx/index.html',

  apkpath: 'http://192.168.10.186/dms_testI/website/assets/download.zip',

  tempurl: 'http://192.168.10.186/dms_testI/admin/storage/temp/',

  createPDFURL: 'http://192.168.10.186/dms_testI/document-writer/word-pdf/index.html',

  createExcelURL: 'http://192.168.10.186/dms_testI/document-writer/xlsx-writer/index.html',
