      ...
      const PDFViewerApplication = {
        ...
        downloadOrSave() {
          if (this.pdfDocument?.annotationStorage.size > 0) {
            ...
            //this.download();
            alert("Nothing Has changed to file");
          }
        },
    ...
    /***/ (__unused_webpack_module, exports) => {
      ...
      };
      {
        ...
        defaultOptions.defaultUrl = {
          // value: "http://172.27.30.93:7001/DMS_PHP/admin/public/Documents/registration-outside-licensing-authority_1679392922.pdf",
          value: filePath,
          kind: OptionKind.VIEWER,
        };
