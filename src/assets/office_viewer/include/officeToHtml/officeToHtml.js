...
(function ($) {
  ...
  $.fn.officeToHtml = function (options) {
    var excelData = options.excelData;
    // console.log(options);
    var $result = $(this);
  ...
  function getContent(
    ...
    switch (ext) {
      ...
      case "fods":
        ...
        getSheetContent(fObj, divId, sheetSet, excelData);
        //alert();
        break;
      case "gif":
      case "jpg":
  ...
  function getDocxContent(fObj, divId, docxSet) {
    ...
    function displayResult(result) {
      ...
      $("#" + divId).editable({ inlineMode: false, autosave: true });
  ...
  /////////////////////////////////////////////////Sheet//////////////////////////////////////////
  function getSheetContent(fObj, divId, sheetSet, excelData) {
    ...
    req.onload = function (e) {
      ...
      // if(excelData){
      //     //
      //     var a=JSON.parse(excelData);
      //     console.log(a);
      //     var data = new Uint8Array(a);
      //     var wb = XLSX.read(a, { type: "array" });
      //       for(var i =0;i<a.length;i++){
      //         sheetNames.push(a[i].name);
      //         sheetNamesData.push(a[i]);
      //       }
      //     //
      // }else{
      //   // console.log('hi');
      ...
      sheetNames.forEach(function (sheetName, idx) {
        ...
        // if(excelData){
        //     var subDivId = "wbSheets_" + idx;
        //     var json=JSON.parse(excelData);
        //     json = XLSX.utils.sheet_to_json(json, {
        //       header: 1,
        //     });
        // }else{
        //     var subDivId = "wbSheets_" + idx;
        ...
        var a=JSON.stringify(excelData);
        // console.log(a);
        var json = XLSX.utils.sheet_to_json(wb.Sheets[sheetName], {
          header: 1,
        });

        // json=[[],[],[],[],[],[null,null,"CSM Framework"],[],[],["Revision History"],["Rev",null,"Descripton of Changes",null,"Author",null,"Effective Date"],["1.0",null,"Document Creation",null,"Sudam Chandra Panda",null,"1-AUG-2022"],["1.1",null,"Updating Team Structure and FRS number status in Master",null,"Sudam Chandra Panda",null,"08-NOV-2022"],["1.2",null,"Remove Umesh Bhatt of Java tech lead and add Trupimayee Saw in java team and updating versioning",null,"Sudam Chandra Panda",null,"11-NOV-2022"],["1.3",null,"Updating versionsing of code generation and framework  and Usablity and Adding Jivan Jyoti Ray in PHP team",null,"Sudam Chandra Panda",null,"03-FEB-2023"],["1.4",null,"Updating Java Resouce Subhadarshini Das, Sibani Nayak, Swetalin Raul, Soumyaranjan Das, Rutuparna Panigrahi & Santosh Kumar Manasingh",null,"Sudam Chandra Panda",null,"08-FEB-2023"],["1.5",null,"Updting resouce,  FRS Completion status, DMS progress and Rule engine progress status",null,"Sudam Chandra Panda",null,"11-Apr-23"],[],[],[]];
        // console.log(json);
        // console.log(JSON.stringify(json));
        var rows = [];
        json.forEach(function (jsonData, i) {
          var cells = [];
          jsonData.forEach(function (jsonVal, ind) {
            cells.push({ text: jsonVal });
          });
          rows.push({ cells: cells });
        });
        var sheetArr = { name: sheetName, rows: rows };
        excelArr.push(sheetArr);
        var dsply = "";
      ...
      console.log(JSON.stringify(excelArr));
      load("#" + divId, excelArr);
      // if (jQuery.ui && sheetSet.jqueryui) {
      //     $("." + divId + "_clas").tabs();
      // } else {
  ...
  function load(divId, arr) {
    ...
    var xs = x_spreadsheet(divId, {
      ...
      extendToolbar: {
        ...
        //     //       //call the api
        //     //       console.log(xs.getData());
        //     //       var newSheetData = xs.getData();
        //     //       //new excel sheet to save in the server
        ...
        //     //       var fileTypename = "application/xlxs";
        //     //       // console.log(fileTypename);
        //     //       var fileTypearr = fileTypename.split("/");
        //     //       var fd = new FormData(); // To carry on your data
        //     //       fd.append("file", newSheetData);
        //     //       fd.append("fileId", fileId);
        //     //       fd.append("fileType", fileTypearr[1]);
        //     //       $.ajax({
        //     //         type: "POST",
        //     //         headers: { Authorization: "bearer " + token },
        //     //         url: "http://172.27.30.93:7001/DMS_PHP/admin/fileUploadWithAnnotation",
        //     //         processData: false,
        //     //         contentType: false,
        //     //         data: fd,
