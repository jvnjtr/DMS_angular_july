!(function (t) {
  ...
  function (t, e, n) {
    ...
    function I(t, e, n) {
      ...
      else if ("/" === t) return D((l = o / a)) > 5 ? l.toFixed(2) : l;
    ...
    function Ht(t) {
      this.l.setAreaOffset(Dt.call(this, t));
    }
    function Mt(t) {
      this.l.setClipboardOffset(Dt.call(this, t));
    }
    function Nt(t) {
    ...
    var Re = function (t) {
      ...
      Ie = function (t, e, n, r) {
        for (var i = [], o = 0; o < t.length; o += 1) {
          ...
          else if ("*" === a) i.push(I("*", i.pop(), i.pop()));
          else if ("/" === a) {
            var f = i.pop();
            i.push(I("/", i.pop(), f));
          } else if ("=" === l || ">" === l || "<" === l) {
    ...
    var Hi = (function (t) {
      function e(t) {
        return (
          ...
          Di(this, Ii(e).call(this, "color", void 0, t))
        );
      }
      var n, r, i;
      return (
    ...
    function Ca() {
      var t,
        ...
        l = a.moreBtns,
        c = a.contentEl;
      n.css("width", "".concat(this.widthFn(), "px"));
      var s = n.box(),
        u = 160,
        f = 12,
        h = [],
    ...
    function Ta(t) {
      var e = this,
        n = new wn();
      n.el.on("click", function () {
        t.onClick && t.onClick(e.data.getData(), e.data);
      }),
        (n.tip = t.tip || "");
      var r = t.el;
      if ((t.icon && (r = a("img").attr("src", t.icon)), r)) {
        var i = a("div", "".concat(kt, "-icon"));
        i.child(r), n.el.child(i);
      }
      return n;
    }
    var Pa = (function () {
      function t(e, n) {
        ...
        var l = e.settings.extendToolbar,
          c = void 0 === l ? {} : l;
        if (c.left && c.left.length > 0) {
          this.items.unshift(_a());
          var s = c.left.map(Ta.bind(this));
          this.items.unshift(s);
        }
        if (c.right && c.right.length > 0) {
          this.items.push(_a());
          var u = c.right.map(Ta.bind(this));
          this.items.push(u);
        }
        this.items.push([(this.moreEl = new xa())]),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if ((e.type || e.pattern) && !(e.pattern || Fa[e.type]).test(i))
                  return (
    ...
    var Ya = 100,
      $a = (function (t) {
        function e() {
          ...
          var n = new Wa(
              new Ma("cell", ["cell"], "100%", function (t) {
            ...
            r = new Wa(new za("120px", "E3 or E3:F12"), {
              required: !0,
            ...
            l = new Wa(new za("70px", "10"), { required: !0 }).hide(),
            c = new Wa(new za("70px", "100"), {
              required: !0,
              type: "number",
            }).hide(),
            s = new Wa(new za("120px", "a,b,c"), { required: !0 }),
            u = new Wa(new za("70px", "10"), {
              required: !0,
              type: "number",
            }).hide();
          return (
            ((t = Ba(
              this,
              La(e).call(this, L("contextmenu.validation"), [
      ...
      function t() {
        ...
        !(function (t, e) {
          ...
          (this.el = a("div", "".concat(kt, "-sort-filter"))
            .children(
              (this.sortAscEl = Ka.call(this, "asc")),
              (this.sortDescEl = Ka.call(this, "desc")),
              Za("divider"),
    ...
    function sl() {
      var t = this.data,
        e = this.selector;
      "read" !== t.settings.mode &&
        (t.copy(), t.copyToSystemClipboard(), e.showClipboard());
    }
    function ul() {
      var t = this.data,
        e = this.selector;
      "read" !== t.settings.mode && (t.cut(), e.showClipboard());
    }
    function fl(t, e) {
      var n = this.data;
      if ("read" !== n.settings.mode)
        if (
          ...
          this.data.pasteFromText(r), ll.call(this);
        }
    }
    function hl(t, e) {
      this.data.unhideRowsOrCols(t, e), ll.call(this);
    }
    function pl(t) {
      var e = this,
        n = this.selector,
      ...
      t.shiftKey ||
        (c ? n.showAutofill(d, y) : rl.call(this, !1, d, y),
        mt(
          window,
          function (t) {
            ...
            (d = i.ri),
              ...
              c
                ? n.showAutofill(d, y)
                : 1 !== t.buttons || t.shiftKey || rl.call(e, !0, d, y, !0, !0);
          },
          function () {
            c &&
              n.arange &&
        ...
        c || 1 !== t.buttons || (t.shiftKey && rl.call(this, !0, d, y));
    }
    function dl() {
      var t = this.editor,
    ...
    function gl(t, e) {
      ...
      if ("undo" === t) this.undo();
      ...
      else if ("paintformat" === t) !0 === e ? sl.call(this) : cl.call(this);
      else if ("clearformat" === t) bl.call(this, "delete-cell-format");
      else if ("link" === t);
      else if ("chart" === t);
      else if ("autofilter" === t)
        (function () {
          this.data.autofilter(), ll.call(this);
        }).call(this);
      else if ("freeze" === t)
        if (e) {
          var r = n.selector,
        ...
        n.setSelectedCellAttr(t, e),
          "formula" !== t || n.selector.multiple() || yl.call(this),
          ll.call(this);
    }
    function ml() {
      var t,
      ...
      c
          ...
          p.clear(),
            ...
            2 === t.buttons
              ? (a.data.xyInSelectedRect(t.offsetX, t.offsetY)
                  ...
                  : (pl.call(a, t), d.setPosition(t.offsetX, t.offsetY)),
                t.stopPropagation())
              : 2 === t.detail
              ? yl.call(a)
              : pl.call(a, t);
        ...
        .on("mousewheel.stop", function (t) {
          (function (t) {
            var e = this.verticalScrollbar,
              ...
              p = Math.abs(s),
              d = Math.max(h, p);
            /Firefox/i.test(window.navigator.userAgent) && nl(f(t.detail), 50),
              d === p &&
                nl(
                  (function (t) {
                    if (t > 0) {
        ...
        (y.change = function (t, e) {
          return gl.call(a, t, e);
        }),
        (b.ok = function (t, e, n, r) {
          return function (t, e, n, r) {
            this.data.setAutoFilter(t, e, n, r), ll.call(this);
          }.call(a, t, e, n, r);
        }),
        ...
        (f.moveFn = function (t, e) {
          (function (t) {
            ...
            n.scrolly(t, function () {
              i.resetBRLAreaOffset(), dl.call(e), r.render();
            });
          }).call(a, t, e);
        }),
        (h.moveFn = function (t, e) {
          (function (t) {
            ...
            n.scrollx(t, function () {
              i.resetBRTAreaOffset(), dl.call(e), r.render();
            });
          }).call(a, t, e);
        }),
        ...
        (d.itemClick = function (t) {
          "validation" === t
            ...
            : "hide" === t
            ? function () {
                this.data.hideRowsOrCols(), ll.call(this);
              }.call(a)
            : bl.call(a, t);
        }),
        yt(window, "resize", function () {
        ...
        yt(window, "paste", function (t) {
          a.focusing && (fl.call(a, "all", t), t.preventDefault());
        }),
            ...
            if (r || o)
              switch (e) {
                ...
                case 86:
                  break;
                case 37:
                  il.call(a, i, "row-first"), t.preventDefault();
                  break;
                case 38:
                  il.call(a, i, "col-first"), t.preventDefault();
                  break;
                case 39:
                  il.call(a, i, "row-last"), t.preventDefault();
                  break;
                case 40:
                  il.call(a, i, "col-last"), t.preventDefault();
                  break;
                case 32:
                  rl.call(a, !1, -1, a.data.selector.ci, !1),
                    t.preventDefault();
                  break;
                case 66:
                  y.trigger("bold");
              ...
              switch (e) {
                case 32:
                  i && rl.call(a, !1, a.data.selector.ri, -1, !1);
                  break;
                case 27:
                  d.hide(), cl.call(a);
                  break;
                case 37:
                  il.call(a, i, "left"), t.preventDefault();
                  break;
                case 38:
                  il.call(a, i, "up"), t.preventDefault();
                  break;
                case 39:
                  il.call(a, i, "right"), t.preventDefault();
                  break;
                case 40:
                  il.call(a, i, "down"), t.preventDefault();
                  break;
                case 9:
                  p.clear(),
                    il.call(a, !1, i ? "left" : "right"),
                    t.preventDefault();
                  break;
                case 13:
                  p.clear(),
                    il.call(a, !1, i ? "up" : "down"),
                    t.preventDefault();
                  break;
                case 8:
                  bl.call(a, "delete-cell-text"), t.preventDefault();
              }
              "Delete" === n
                ? (bl.call(a, "delete-cell-text"), t.preventDefault())
                : (e >= 65 && e <= 90) ||
                  ...
                  (e >= 96 && e <= 105) ||
                  "=" === t.key
                ? (vl.call(a, t.key, "input"), yl.call(a))
                : 113 === e && yl.call(a);
            }
          }
        });
    ...
    var wl = (function () {
      function t(e, n) {
        ...
        (this.el = a("div", "".concat(kt, "-sheet"))),
          (this.toolbar = new Pa(n, o.width, !l)),
          (this.print = new pn(n)),
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "loadData",
            value: function (t) {
              return this.data.setData(t), ll.call(this), this;
            },
          },
          {
            key: "freeze",
            value: function (t, e) {
              return this.data.setFreeze(t, e), ll.call(this), this;
            },
          },
          {
            key: "undo",
            value: function () {
              this.data.undo(), ll.call(this);
            },
          },
          {
            key: "redo",
            value: function () {
              this.data.redo(), ll.call(this);
            },
          },
          {
            key: "reload",
            value: function () {
              return ll.call(this), this;
            },
          },
          {
            key: "getRect",
    ...
    function jl(t, e, n) {
      return e && El(t.prototype, e), n && El(t, n), t;
    }
    function _l(t, e) {
      return !e || ("object" !== Ol(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
    ...
    var Pl = (function (t) {
        function e(t) {
          ...
          return (
            ((n = _l(
              this,
              Cl(e).call(this, r, "auto", !1, "top-left")
            )).contentClick = t),
            n
          );
        }
          ...
          jl(e, [
            {
              ...
              value: function (t) {
                ...
                this.setContentChildren.apply(this, Sl(n));
              },
            },
      ...
      Al = [{ key: "delete", title: U("contextmenu.deleteSheet") }];
    function Rl() {
      var t = this;
      ...
      Il = (function () {
        function t() {
          ...
          xl(this, t),
            ...
            (this.deleteEl = null),
            (this.items = []),
            (this.moreEl = new Pl(function (t) {
              e.clickSwap2(e.items[t]);
            })),
            (this.contextMenu = new Dl()),
            ...
            },
            {
              ...
              value: function () {
                if (null !== this.bottombar) {
                  var t = zl(this.bottombar.deleteItem(), 2),
                    e = t[0],
                    n = t[1];
                  e >= 0 &&
