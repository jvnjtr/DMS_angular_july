...
!(function (a) {
  ...
  (b.VALID_NODES = [
    ...
    (b.commands = {
      bold: { title: "Bold (Ctrl + B)", icon: "fa fa-bold" },
      italic: { title: "Italic (Ctrl + I)", icon: "fa fa-italic" },
      underline: {
        cmd: "underline",
        title: "Underline (Ctrl + U)",
        icon: "fa fa-underline",
      },
      strikeThrough: { title: "Strike Through", icon: "fa fa-strikethrough" },
      fontSize: {
        title: "Font Size",
      ...
      color: {
        icon: "fa fa-font",
        seed: [
          { cmd: "backColor", value: b.COLORS, title: "Background Color" },
          { cmd: "foreColor", value: b.COLORS, title: "Foreground Color" },
        ],
      },
      formatBlock: {
        title: "Format Block",
      ...
      insertOrderedList: { title: "Numbered List", icon: "fa fa-list-ol" },
      insertUnorderedList: { title: "Bulleted List", icon: "fa fa-list-ul" },
      outdent: {
      ...
      selectAll: { title: "Select All (Ctrl + A)", icon: "fa fa-file-text" },
      createLink: { title: "Insert Link (Ctrl + K)", icon: "fa fa-link" },
      insertImage: {
        title: "Insert Image (Ctrl + P)",
        icon: "fa fa-picture-o",
        activeless: !0,
      },
      undo: { title: "Undo (Ctrl+Z)", icon: "fa fa-undo", activeless: !0 },
      redo: {
        title: "Redo (Shift+Ctrl+Z)",
        icon: "fa fa-repeat",
        activeless: !0,
      },
      html: { title: "Show Html", icon: "fa fa-code" },
    }),
    (b.DEFAULTS = {
      autosave: !1,
      autosaveInterval: 1e3,
      saveURL: commonCkeditorSaveUrl,
      blockTags: [
        "n",
        "p",
        "blockquote",
      ...
      imageUploadURL: commonCkeditorSaveUrl,
      inlineMode: !0,
    ...
    (b.browser = function () {
      ...
      return (
        b[1] && (d[c.browser] = !0),
        parseInt(c.version, 10) < 9 && d.msie && (d.oldMsie = !0),
    ...
    (b.prototype.getSelectionParent = function () {
      ...
      return (
        window.getSelection
          ? ((a = window.getSelection()),
            a.rangeCount &&
              ((b = a.getRangeAt(0).commonAncestorContainer),
              1 != b.nodeType && (b = b.parentNode)))
          : (a = document.selection) &&
            "Control" != a.type &&
            (b = a.createRange().parentElement()),
        b
      );
    }),
    (b.prototype.nodeInRange = function (a, b) {
      ...
      return (
        -1 == a.compareBoundaryPoints(Range.END_TO_START, c) &&
        1 == a.compareBoundaryPoints(Range.START_TO_END, c)
      );
    }),
    (b.prototype.getElementFromNode = function (c) {
      for (
        1 != c.nodeType && (c = c.parentNode);
        null != c && b.VALID_NODES.indexOf(c.tagName) < 0;

      )
        c = c.parentNode;
      return jQuery.makeArray(a(c).parents()).indexOf(this.$element.get(0)) >= 0
        ? c
        : null;
    }),
    ...
    (b.prototype.getSelectionLink = function () {
      ...
      return (
        window.getSelection
          ? ((b = window.getSelection()), (a = b.anchorNode.parentNode.href))
          : (b = document.selection) &&
            "Control" != b.type &&
            (a = b.createRange().parentElement().href),
        a
      );
    }),
    ...
    (b.prototype.restoreSelection = function () {
      ...
      if (this.savedRanges)
        for (
          c.removeAllRanges(), a = 0, b = this.savedRanges.length;
          b > a;
          a += 1
        )
    ...
    (b.prototype.restoreSelectionByMarkers = function () {
      ...
      return a.length && b.length
        ? (this.$element.focus(),
          this.setSelection(a[0], 0, b[0], 0),
          void this.removeMarkers())
        : !1;
    }),
    ...
    (b.prototype.placeMarker = function (b, c) {
      var d = b.cloneRange();
      d.collapse(c),
        d.insertNode(a('<span id="marker-' + c + '">', document)[0]),
        d.detach();
    }),
    ...
    (b.prototype.repositionEditor = function () {
      if (this.options.inlineMode) {
        ...
        if (b.left && b.top && b.right && b.bottom) {
          ...
          this.isTouch() &&
            ((c = b.left + b.width / 2), (d = b.top + b.height)),
          ...
          var b = this.getRange().getBoundingClientRect(),
            ...
            d = b.top + b.height + a(window).scrollTop();
          this.isTouch() && ((c = b.left), (d = b.top + b.height)),
            this.showByCoordinates(c, d - 20),
    ...
    (b.prototype.destroy = function () {
      this.sync(),
        ...
        this.$textarea && (this.$box.remove(), this.$textarea.show());
    }),
    (b.prototype.callback = function (b, c) {
      var d = b + "Callback";
      this.options[d] &&
        a.isFunction(this.options[d]) &&
        (c ? this.options[d].call(this, c) : this.options[d].call(this)),
        this.sync();
    }),
    (b.prototype.sync = function () {
      this.$textarea && this.$textarea.val(this.getHTML()),
    ...
    (b.prototype.initLink = function () {
      ...
      this.$element.on("click touchend", "a", function (c) {
        c.stopPropagation(),
          ...
          (b.link = !0),
          "" == b.text() &&
            (a(this).prepend('<span id="marker-true"></span>'),
            a(this).append('<span id="marker-false"></span>'),
            b.restoreSelectionByMarkers(),
            b.$bttn_wrapper.find('[data-cmd="createLink"]').click(),
            b.$link_wrapper
              .find('input[type="text"]')
              .val(a(this).attr("href")),
            b.$link_wrapper
              .find('input[type="checkbox"]')
              .prop("checked", "_blank" == a(this).attr("target")),
            b.repositionEditor(),
            b.$popup_editor.show());
      });
    }),
    (b.prototype.imageHandle = function () {
      var b = this,
        c = a("<span>")
          .addClass("f-img-handle")
          .on({
            movestart: function (c) {
              b.hide(),
                b.$element
                  .addClass("f-non-selectable")
            ...
            move: function (b) {
              ...
              var e = c.prevAll("img");
              e.width(
                c.hasClass("f-h-ne") || c.hasClass("f-h-se")
                  ? e.width() + d
                  : e.width() - d
              );
            },
      ...
      this.$element.on("mousedown", "img", function () {
        ...
        this.$element.on("click touchend", "img", function (b) {
          b.preventDefault(),
            b.stopPropagation(),
            c.$element.blur(),
            c.$image_editor.find("button").removeClass("active");
          var d = a(this).css("float");
          c.$image_editor
            .find(
              'button[data-cmd="floatImage' +
            ...
            .addClass("active"),
            c.$image_editor
              .find('.f-image-alt input[type="text"]')
              .val(a(this).attr("alt") || a(this).attr("title")),
            c.showImageEditor(),
            c.showByCoordinates(
              a(this).offset().left + a(this).width() / 2,
              a(this).offset().top + a(this).height()
            ),
            (a(this).parent().hasClass("f-img-editor") &&
              "SPAN" == a(this).parent().get(0).tagName) ||
              (a(this).wrap(
                '<span class="f-img-editor" style="float: ' +
                  a(this).css("float") +
                  "; margin-left:" +
                  a(this).css("margin-left") +
                  " ; margin-right:" +
                  a(this).css("margin-right") +
                  "; margin-bottom: " +
                  a(this).css("margin-bottom") +
                  ';"></span>'
              ),
              a(this).css("margin-left", "auto"),
              a(this).css("margin-right", "auto"),
              a(this).css("margin-bottom", "auto"));
          var e = c.imageHandle();
          a(this).parent().append(e.clone(!0).addClass("f-h-ne")),
            a(this).parent().append(e.clone(!0).addClass("f-h-se")),
            a(this).parent().append(e.clone(!0).addClass("f-h-sw")),
            a(this).parent().append(e.clone(!0).addClass("f-h-nw")),
            c.clearSelection(),
            (c.imageMode = !0);
        }),
    ...
    (b.prototype.initImagePopup = function () {
      ...
      var b = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "floatImageLeft")
          .attr("title", "Float left")
          .html('<i class="fa fa-align-left"></i>'),
        c = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "floatImageNone")
          .attr("title", "Float none")
          .html('<i class="fa fa-align-justify"></i>'),
        d = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "floatImageRight")
          .attr("title", "Float right")
          .html('<i class="fa fa-align-right"></i>'),
        e = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "linkImage")
          .attr("title", "Insert link")
          .html('<i class="fa fa-link"></i>'),
        f = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "replaceImage")
          .attr("title", "Replace image")
          .html('<i class="fa fa-exchange"></i>'),
        g = a("<button>")
          .addClass("cl-bttn")
          .attr("data-cmd", "removeImage")
          .attr("title", "Remove image")
          .html('<i class="fa fa-trash-o"></i>'),
        h = a('<div class="f-image-alt">')
          .append("<label>Title: </label>")
          .append(
            a('<input type="text">').on(
          ...
          .append(
            a("<button>")
              .attr("data-cmd", "setImageAlt")
              .attr("title", "OK")
              .html("OK")
          );
      this.$image_editor = a("<div>")
        .addClass("bttn-wrapper f-image-editor")
        .append(b)
        .append(c)
        .append(d)
        .append(e)
      ...
      this.$image_editor.find("button").click(function (b) {
        b.stopPropagation(),
          i[a(this).attr("data-cmd")](i.$element.find("span.f-img-editor"));
      }),
        this.$popup_editor.append(this.$image_editor);
    }),
    (b.prototype.floatImageLeft = function (a) {
      a.css("margin-left", "auto"),
        a.css("margin-right", this.options.imageMargin),
        a.css("margin-bottom", this.options.imageMargin),
        a.css("float", "left"),
        a.find("img").css("float", "left"),
        this.saveUndoStep(),
    ...
    (b.prototype.floatImageNone = function (a) {
      a.css("margin-left", "auto"),
        ...
        a.css("margin-bottom", this.options.imageMargin),
        a.css("float", "none"),
        a.find("img").css("float", "none"),
        a.parent().get(0) == this.$element.get(0)
          ? a.wrap('<div style="text-align: center;"></div>')
    ...
    (b.prototype.floatImageRight = function (a) {
      a.css("margin-right", "auto"),
        a.css("margin-left", this.options.imageMargin),
        a.css("margin-bottom", this.options.imageMargin),
        a.css("float", "right"),
        a.find("img").css("float", "right"),
        this.saveUndoStep(),
    ...
    (b.prototype.linkImage = function (a) {
      this.showInsertLink(),
        (this.imageMode = !0),
        "A" == a.parent().get(0).tagName
          ? (this.$link_wrapper
              .find('input[type="text"]')
              .val(a.parent().attr("href")),
            "_blank" == a.parent().attr("target")
              ? this.$link_wrapper
                  .find('input[type="checkbox"]')
                  .prop("checked", !0)
              : this.$link_wrapper
    ...
    (b.prototype.replaceImage = function (a) {
      this.showInsertImage(),
        ...
        this.$image_wrapper
          .find('input[type="text"]')
          .val(a.find("img").attr("src"));
    }),
    (b.prototype.removeImage = function (a) {
      this.callback("beforeRemoveImage"),
        confirm("Are you sure? Image will be deleted.")
          ? (a.remove(),
            this.hide(),
            this.saveUndoStep(),
    ...
    (b.prototype.setImageAlt = function (a) {
      a
        ...
        .attr(
          "alt",
          this.$image_editor.find('.f-image-alt input[type="text"]').val()
        ),
        a
          .find("img")
          .attr(
    ...
    (b.prototype.initElement = function (b) {
      "TEXTAREA" == b.tagName
        ...
        : ("DIV" != b.tagName &&
            this.options.buttons.indexOf("formatBlock") >= 0 &&
      ...
      this.$element.contents().filter(function () {
        if (
          (this.nodeType == Node.TEXT_NODE &&
            a(this).text().trim().length > 0) ||
          c.indexOf(this.tagName) >= 0
        )
          b.push(this);
        else {
          var d = a("<div>");
          for (var e in b)
            d.append(a(b[e]).clone()),
              e == b.length - 1 ? a(b[e]).replaceWith(d) : a(b[e]).remove();
          b = [];
        }
      }),
    ...
    (b.prototype.setHTML = function (b) {
      this.$element.html(a.htmlClean(b, { format: !0 })), this.wrapText();
    }),
    (b.prototype.initElementStyle = function () {
      this.$element.attr("contentEditable", !0),
        this.$element
          .addClass("froala-element")
          .addClass(this.options.editorClass),
        this.$element.css("outline", 0);
    }),
    (b.prototype.initUndoRedo = function () {
      (this.isEnabled("undo") || this.isEnabled("redo")) &&
        ((this.undoStack = []),
        (this.undoIndex = 0),
        this.saveUndoStep(),
        this.enableTypingUndo()),
          ...
          a.proxy(function () {
            clearTimeout(this.typingTimer),
              ...
              (this.typingTimer = setTimeout(
                ...
                Math.max(this.options.typingTimer, 200)
              ));
          }, this)
        );
    }),
    (b.prototype.getHTML = function () {
      ...
      return (
        b.find(".f-img-editor > img").each(function (b, c) {
          a(c).css("margin-left", a(c).parent().css("margin-left")),
            a(c).css("margin-right", a(c).parent().css("margin-right")),
            a(c).css("margin-bottom", a(c).parent().css("margin-bottom")),
            a(c).siblings("span.f-img-handle").remove().end().unwrap();
        }),
        a.htmlClean(b.html())
      );
    }),
        ...
        (this.ajaxHTML = this.getHTML()),
          ...
          (this.ajaxInterval = setInterval(
            a.proxy(function () {
              this.ajaxHTML != this.getHTML() &&
                this.ajaxSave &&
                (this.save(), (this.ajaxHTML = this.getHTML())),
                (this.ajaxSave = !0);
            }, this),
            Math.max(this.options.autosaveInterval, 1e3)
          ));
        {
          this.$element.html();
        }
      ...
      this.options.shortcuts &&
        this.$element.on(
          ...
          a.proxy(function (a) {
            ...
            if (!this.isHTML && c) {
              ...
              if (80 == b)
                return (
                  ...
                  this.execDefaultShortcut("insertImage")
                );
            ...
            9 != b || a.shiftKey
              ? 9 == b && a.shiftKey && a.preventDefault()
              : (a.preventDefault(),
                this.insertHTML("&nbsp;&nbsp;&nbsp;&nbsp;", !1));
          }, this)
        );
    ...
    (b.prototype.insertHTML = function (a, b) {
      ...
      if (window.getSelection) {
        if (((c = window.getSelection()), c.getRangeAt && c.rangeCount)) {
          ...
          e.innerHTML = a;
          for (
            var f, g, h = document.createDocumentFragment();
            (f = e.firstChild);
          ...
          d.insertNode(h),
            g &&
              ((d = d.cloneRange()),
              d.setStartAfter(g),
              b ? d.setStartBefore(i) : d.collapse(!0),
              c.removeAllRanges(),
              c.addRange(d));
        }
    ...
    (b.prototype.initBasicEditor = function () {
      this.$element.addClass("f-basic"),
        ...
        this.$popup_editor.appendTo(a("body")),
    ...
    (b.prototype.closeImageMode = function () {
      this.$element.find("span.f-img-editor > img").each(function (b, c) {
        ...
        this.$element.find("span.f-img-editor").length &&
      ...
      this.$element.on(
        ...
        this.$element.on(
          ...
          a.proxy(function (a) {
            var b = this.text();
            "" == b || this.isTouch()
              ? this.options.inlineMode || this.refreshButtons()
              : (a.stopPropagation(), this.show(a)),
              (this.imageMode = !1);
          }, this)
        ),
        this.$element.on(
        ...
        this.$link_wrapper.on(
          "mouseup",
          a.proxy(function (a) {
            a.stopPropagation();
          })
        ),
        this.$image_wrapper.on(
          "mouseup",
          a.proxy(function (a) {
            a.stopPropagation();
          })
        ...
        a(window).on(
          "mouseup touchend",
          a.proxy(function () {
            this.selectionInEditor() && "" != this.text() && !this.isTouch()
              ? this.show(null)
        ...
        a.proxy(function () {
          "" == this.$element.text()
            ? ((this.placeholderVisible = !0),
              ...
              this.$element.text(this.options.placeholder))
    ...
    (b.prototype.setDirection = function (a) {
      a && (this.options.direction = a),
        ...
        this.$element.css("direction", this.options.direction);
    }),
    ...
    (b.prototype.setButtons = function (c) {
      ...
      for (var d in this.options.buttons) {
        ...
        if (void 0 != e)
          switch (((e.cmd = this.options.buttons[d]), e.cmd)) {
            case "color":
            ...
            case "html":
              ...
              this.$bttn_wrapper.append(g),
                this.options.inlineMode &&
                  this.$box.append(
                    g
                      .clone(!0)
                      .addClass("html-switch")
                      .attr("title", "Hide HTML")
                      .click(
                        a.proxy(function () {
                          this.html();
                        }, this)
              ...
              this.$html_area = a('<textarea wrap="hard">').keydown(function (
                b
              ) {
                ...
                if (9 == c) {
                  ...
                  a(this).val(
                    a(this).val().substring(0, d) +
                      "   " +
                      a(this).val().substring(e)
                  ),
                    (a(this).get(0).selectionStart = a(this).get(
                      0
                    ).selectionEnd =
                      d + 1);
                }
    ...
    (b.prototype.buildDefaultButton = function (b) {
      var c = a("<button>")
        ...
        .attr("title", b.title)
        .attr("data-cmd", b.cmd)
        .attr("data-activeless", b.activeless);
    ...
    (b.prototype.addButtonIcon = function (b, c) {
      b.append(
        c.icon
          ? a("<i>").addClass(c.icon)
          : c.icon_alt
          ? a("<i>").addClass("for-text").html(c.icon_alt)
          : c.title
      );
    }),
        ...
        for (var g in e.value) {
          ...
          f.append(
            ...
            g % 8 == 7 &&
              ...
              (f.append("<hr/>"),
              (7 == g || 15 == g) &&
                f.append(a("<div>").addClass("separator")));
        }
        c.append(f);
      }
      return c;
      ...
      for (var d in b.seed)
        for (var e = b.seed[d], f = e.min; f <= e.max; f++) {
          var g = a("<li>")
            ...
            .attr("data-val", f + "px")
            .attr("data-activeless", b.activeless)
            .append(a('<a href="#">').append(a("<span>").text(f + "px")));
          c.append(g);
        }
      return c;
    }),
    (b.prototype.buildDropdownFormatblock = function (b) {
      ...
      for (var d in b.seed) {
        ...
        if (
          "n" == e.value ||
          -1 != a.inArray(e.value, this.options.blockTags)
        ) {
          var f = a("<li>").append(
            a("<li>")
              .attr("data-cmd", b.cmd)
              .attr("data-val", e.value)
              .attr("data-activeless", b.activeless)
              .append(
                a('<a href="#">')
                  .addClass("format_" + e.value)
                  .attr("title", e.title)
                  .text(e.title)
              )
          );
    ...
    (b.prototype.buildInsertImage = function () {
      (this.$image_wrapper = a("<div>").addClass("image-wrapper")),
        this.$popup_editor.append(this.$image_wrapper);
      var b = this;
      this.$progress_bar = a('<p class="f-progress">').append("<span></span>");
      var c = a('<div class="f-upload">')
        .append("<strong>Drop Image</strong><br>(or click)")
        .append(
          a('<form method="post" enctype="multipart/form-data">').append(
            a(
              '<input type="file" name="' +
                this.options.imageUploadParam +
                '" accept="image/*" />'
            ).change(function () {
      ...
      // alert();
      var d = a('<input type="text" placeholder="http://example.com"/>').on(
        "mouseup touchend keydown",
        a.proxy(function (a) {
          a.stopPropagation();
        }, this)
      );
      (this.$image_list = a("<ul>")
        .append(a('<li class="drop-upload">').append(c))
        .append(
          a('<li class="url-upload">')
            .append("<label>Enter URL: </label>")
            .append(d)
            .append(
              a("<button>OK</button>").click(
                a.proxy(function () {
        ...
        this.$image_wrapper
          .append(
            a("<h4>")
              .text("Insert image")
              .append(
                a('<i class="fa fa-times" title="Cancel">').click(
                  a.proxy(function () {
    ...
    (b.prototype.buildCreateLink = function () {
      ...
      var b = a('<input type="text">')
        ...
        e = a('<button type="button" class="f-unlink">')
          .text("UNLINK")
          .on(
            "click touch",
            a.proxy(function () {
      ...
      this.$link_wrapper
        ...
        .append(
          a("<p>")
            .append(c)
            .append(' <label for="f-checkbox">Open in new tab</label>')
            .append(d)
            .append(e)
        )
        .end()
      ...
      b.on({
        ...
        drop: function (b) {
          a(this).removeClass("f-hover"),
            b.preventDefault(),
            c.uploadFile(b.originalEvent.dataTransfer.files);
        },
      });
    }),
    (b.prototype.writeImage = function (b) {
      ...
      if (this.imageMode) {
        var c = new Image();
        return (
          this.options.imageErrorCallback &&
            a.isFunction(this.options.imageErrorCallback) &&
            (c.onerror = this.options.imageErrorCallback({
              errorCode: 1,
              errorStatus: "Bad link.",
            })),
          (c.onload = a.proxy(function () {
            this.$element.find(".f-img-editor > img").attr("src", b),
              this.hide(),
              ...
              this.saveUndoStep(),
              this.callback("replaceImage", { imageURL: b });
          }, this)),
          (c.src = b),
          !1
        );
        ...
        (c.onload = a.proxy(function () {
          ...
          a(d).prepend(
            '<img alt="Image title" src="' +
              b +
              '" width="200" style="float: left; min-width: 16px; min-height: 16px; margin-bottom: ' +
              this.options.imageMargin +
              "px; margin-right: " +
              this.options.imageMargin +
              'px">'
          ),
            (a(d).find("img:first").get(0).oncontrolselect = function () {
              return !1;
            }),
            this.saveUndoStep(),
            this.hide(),
            ...
            this.$progress_bar.find("span").css("width", "0%").text(""),
            this.$image_list.show(),
            this.callback("insertImage", { imageURL: b });
        }, this)),
        (c.src = b);
    }),
    (b.prototype.uploadFile = function (b) {
      ...
      if (
        (b.length > 0 &&
          this.drag_support.formdata &&
          c.append(this.options.imageUploadParam, b[0]),
        this.drag_support.formdata)
      ) {
        var d;
        this.options.crossDomain
          ? (d = this.createCORSRequest("POST", this.options.imageUploadURL))
          : ((d = new XMLHttpRequest()),
            d.open("POST", this.options.imageUploadURL)),
          (d.onload = a.proxy(function () {
            ...
            console.log(this.options.imageUploadURL);
            commonCkeditorSaveUrl == this.options.imageUploadURL
              ? 200 == b.status_code
                ? this.writeImage(b.img_url)
                : this.options.imageErrorCallback({
                    errorCode: 3,
                    errorStatus: "Error during file upload.",
                  })
              : b.link
              ? this.writeImage(b.link)
              : this.options.imageErrorCallback &&
                a.isFunction(this.options.imageErrorCallback) &&
                (img.onerror = this.options.imageErrorCallback({
                  errorCode: 2,
          ...
          (d.upload.onprogress = a.proxy(function (a) {
    ...
    (b.prototype.writeLink = function (b, c) {
      if (this.imageMode)
        return (
          "" != b
            ? ("A" !=
              this.$element.find(".f-img-editor").parent().get(0).tagName
                ? this.$element
                    .find(".f-img-editor")
                    .wrap(
                      1 == c
                        ? '<a href="' + b + '" target="_blank"></a>'
                        : '<a href="' + b + '"></a>'
                    )
                : 1 == c
                ? this.$element
                ...
                : (this.$element
                    ...
                    .parent()
                    .removeAttr("target"),
                  this.$element.find(".f-img-editor").parent().attr("href", b)),
              this.callback("insertImageLink", { URL: b }))
            : ("A" ==
                this.$element.find(".f-img-editor").parent().get(0).tagName &&
                a(this.$element.find(".f-img-editor").get(0)).unwrap(),
      ...
      if (
        (this.restoreSelection(),
        document.execCommand("unlink", !1, b),
        this.saveSelectionByMarkers(),
        this.$element.find("span.f-link").each(function (b, c) {
        ...
        for (var d = this.getSelectionLinks(), e = 0; e < d.length; e++)
          1 == c && a(d[e]).attr("target", "_blank"),
            a(d[e]).addClass("f-link");
        this.$element.find("a:empty").remove(),
          this.callback("insertLink", { URL: b });
      } else
    ...
    (b.prototype.getSelectionLinks = function () {
      ...
      if (window.getSelection) {
          ...
          for (var g = 0; g < f.rangeCount; ++g)
            if (
              ...
              for (var h = 0; h < c.length; ++h)
                d.selectNodeContents(c[h]),
                  d.compareBoundaryPoints(a.END_TO_START, a) < 1 &&
                    d.compareBoundaryPoints(a.START_TO_END, a) > -1 &&
                    e.push(c[h]);
            }
          d.detach();
        }
        ...
        if (
          ...
          for (var h = 0; h < c.length; ++h)
            d.moveToElementText(c[h]),
              d.compareEndPoints("StartToEnd", a) > -1 &&
                d.compareEndPoints("EndToStart", a) < 1 &&
                e.push(c[h]);
        }
      return e;
    }),
    ...
    (b.prototype.show = function (b) {
      if (this.options.inlineMode)
        if (null != b && "touchend" != b.type) {
          ...
          20 > c && (c = 20),
            0 > d && (d = 0),
            c + this.$editor.width() > a(window).width() - 50
              ? (this.$editor.addClass("right-side"),
                (c = a(window).width() - (c + 30)),
                this.$editor.css("top", d + 20),
                this.$editor.css("right", c),
                this.$editor.css("left", "auto"))
              : (this.$editor.removeClass("right-side"),
                this.$editor.css("top", d + 20),
                this.$editor.css("left", c - 20),
          ...
          a(".froala-editor:not(.f-basic)").hide(),
            this.$editor.show(),
            this.repositionEditor();
      this.isEnabled("createLink") && this.$link_wrapper.hide(),
        this.isEnabled("insertImage") && this.$image_wrapper.hide(),
        this.$bttn_wrapper.show(),
        this.$bttn_wrapper.find(".clump-dropdown").removeClass("active"),
        this.refreshButtons(),
        (this.imageMode = !1);
    }),
    (b.prototype.showByCoordinates = function (b, c) {
      (b -= 20),
        (c += 15),
        b + this.$popup_editor.width() > a(window).width() - 50
          ? (this.$popup_editor.addClass("right-side"),
            (b = a(window).width() - (b + 40)),
            this.$popup_editor.css("top", c),
            this.$popup_editor.css("right", b),
            this.$popup_editor.css("left", "auto"))
          : (this.$popup_editor.removeClass("right-side"),
            this.$popup_editor.css("top", c),
            this.$popup_editor.css("left", b),
    ...
    (b.prototype.positionPopup = function (a) {
      this.$popup_editor.css(
        "top",
        this.$editor.find('button.cl-bttn[data-cmd="' + a + '"]').offset().top +
          30
      ),
        this.$popup_editor.css(
          "left",
          this.$editor.find('button.cl-bttn[data-cmd="' + a + '"]').offset()
            .left
        ),
        this.$popup_editor.show();
    }),
    ...
    (b.prototype.bindDropdownEvents = function () {
      this.$bttn_wrapper
        .find(".clump-dropdown .cl-trigger")
        .on("click touchend", function (b) {
          return (
            b.stopPropagation(),
            b.preventDefault(),
            a(this).parents(".clump-dropdown").attr("data-disabled")
              ? !1
              : (a(".clump-dropdown")
                  .not(a(this).parents(".clump-dropdown"))
                  .removeClass("active"),
                void a(this).parents(".clump-dropdown").toggleClass("active"))
          );
        }),
        a(window).on(
          "click touchend",
      ...
      b.bind("select", function () {
        a(this)
          .parents(".clump-selector")
          .find(" > button > i")
          .attr("class", a(this).find("i").attr("class"));
      }).on("click touch", function () {
        a(this).parents("ul").find("button").removeClass("active"),
          a(this).trigger("select");
      });
    }),
    (b.prototype.bindCommandEvents = function () {
      this.$bttn_wrapper.find("[data-cmd]").on(
        "click touchend",
        a.proxy(function (b) {
          ...
          var c = b.currentTarget,
            d = a(c).data("cmd"),
            e = a(c).data("val");
          a(c).parents(".clump-dropdown").removeClass("active"),
            this.exec(d, e);
        }, this)
      );
    }),
    (b.prototype.exec = function (a, b) {
      ...
      "undo" != a &&
        ...
        "html" != a &&
        this.saveUndoStep(),
        "createLink" != a && "insertImage" != a && this.refreshButtons();
    }),
    (b.prototype.undo = function () {
      if (this.undoIndex > 1) {
        ...
        this.$element.html(this.undoStack[--this.undoIndex - 1]),
          this.hide(),
          this.callback("undo", { newHTML: this.$element.html(), oldHTML: a });
      }
      this.refreshUndoRedo();
    }),
    (b.prototype.redo = function () {
      if (this.undoIndex < this.undoStack.length) {
        ...
        this.$element.html(this.undoStack[this.undoIndex++]),
          this.hide(),
          this.callback("redo", { newHTML: this.$element.html(), oldHTML: a });
      }
      this.refreshUndoRedo();
    }),
    (b.prototype.save = function () {
      this.options.saveURL
        ...
        : console.log("Save URL missing.");
    }),
    (b.prototype.clean = function () {
      this.$element.html(a.htmlClean(this.$element.html(), { format: !0 }));
    }),
    (b.prototype.html = function () {
      if (this.isHTML) {
        this.isHTML = !1;
        var b = a.htmlClean(this.$html_area.val(), { format: !0 });
        this.$element.html(b).attr("contenteditable", !0),
          this.$box.removeClass("f-html"),
          this.$editor
            .find('.cl-bttn:not([data-cmd="html"])')
            .prop("disabled", !1),
          this.$editor.find("div.cl-bttn").removeAttr("data-disabled"),
          this.$editor.find('.cl-bttn[data-cmd="html"]').removeClass("active"),
          this.saveUndoStep(),
          this.callback("htmlHide", { html: b });
      } else {
        this.isHTML = !0;
        var b = "\n\n" + a.htmlClean(this.$element.html(), { format: !0 });
        this.$html_area.val(b).trigger("resize"),
          this.options.inlineMode &&
            this.$box
              .find(".html-switch")
              .css("top", this.$box.css("padding-top")),
          ...
          this.$editor
            .find('button.cl-bttn:not([data-cmd="html"])')
            .prop("disabled", !0),
          this.$editor.find("div.cl-bttn").attr("data-disabled", !0),
          this.$editor.find('.cl-bttn[data-cmd="html"]').addClass("active"),
          this.options.inlineMode && this.hide(),
          this.callback("htmlShow", { html: b });
      }
    }),
    ...
    (b.prototype.backColor = function (c) {
      ...
      var f = this.$editor.find(
        'button.clump-color-bttn[data-cmd="backColor"][data-val="' + c + '"]'
      );
      f.addClass("active"),
        f.siblings().removeClass("active"),
        this.callback("backColor", {
    ...
    (b.prototype.foreColor = function (c) {
      ...
      document.execCommand("foreColor", !1, c),
        this.saveSelectionByMarkers(),
        this.$element.find("font[color]").each(function (b, d) {
          a(d).replaceWith(a("<span>").css("color", c).html(a(d).html()));
        }),
        this.restoreSelectionByMarkers();
      var e = this.$editor.find(
        'button.clump-color-bttn[data-cmd="foreColor"][data-val="' + c + '"]'
      );
      e.addClass("active"),
        e.siblings().removeClass("active"),
        this.callback("foreColor", {
          newColor: b.hexToRGBString(c),
          oldColor: d,
        });
    }),
    ...
    (b.prototype.formatList = function (b) {
      ...
      for (var f in c) {
        var g = a(c[f]);
        g.parents("li").length > 0
          ? (g.parents("ol").length > 0
              ? (g.parents("li").before('<span class="close-ol"></span>'),
                g.parents("li").after('<span class="open-ol"></span>'))
              : g.parents("ul").length > 0 &&
                (g.parents("li").before('<span class="close-ul"></span>'),
                g.parents("li").after('<span class="open-ul"></span>')),
            g.parents("li").replaceWith(g.parents("li").contents()),
            (e = !0))
          : (d = !1);
      }
      if (e) {
        ...
        (h = h.replace(
          new RegExp('<span class="close-ul"></span>', "g"),
          "</ul>"
        )),
          (h = h.replace(
            new RegExp('<span class="open-ul"></span>', "g"),
            "<ul>"
          )),
          (h = h.replace(
            new RegExp('<span class="close-ol"></span>', "g"),
            "</ol>"
          )),
          (h = h.replace(
            new RegExp('<span class="open-ol"></span>', "g"),
            "<ol>"
          )),
          this.$element.html(h),
      ...
      if (
        ...
        for (var f in c) {
          var g = a(c[f]);
          g.get(0) != this.$element.get(0) &&
            (i.append(a("<li>").append(g.clone())),
            f != c.length - 1 ? g.remove() : g.replaceWith(i));
        }
        this.restoreSelectionByMarkers();
      }
    ...
    (b.prototype.insertLink = function () {
      this.showInsertLink(),
        this.options.inlineMode || this.positionPopup("createLink"),
        this.saveSelection();
      ...
      c.length > 0 &&
        this.$link_wrapper
          .find('input[type="checkbox"]')
          .prop("checked", "_blank" == a(c[0]).attr("target")),
        this.$link_wrapper.find('input[type="text"]').val(b || "http://");
    }),
    ...
    (b.prototype.execDefault = function (a, b) {
      document.execCommand(a, !1, b),
        "insertOrderedList" == a
          ? this.$bttn_wrapper
              .find('[data-cmd="insertUnorderedList"]')
              .removeClass("active")
          : "insertUnorderedList" == a &&
            this.$bttn_wrapper
              .find('[data-cmd="insertOrderedList"]')
              .removeClass("active"),
        this.callback(a);
    }),
    (b.prototype.refreshButtons = function () {
      return !this.selectionInEditor() || this.isHTML
        ? !1
        : (this.refreshUndoRedo(),
          void this.$bttn_wrapper.find("[data-cmd]").each(
    ...
    (b.prototype.refreshFormatBlock = function (b) {
      this.disabledList.indexOf("formatBlock") >= 0 &&
        a(b).parents(".clump-dropdown").attr("data-disabled", !0);
    }),
    (b.prototype.refreshUndoRedo = function () {
      if (this.isEnabled("undo") || this.isEnabled("redo")) {
        if (void 0 == this.$editor) return;
        this.$bttn_wrapper
          .find('[data-cmd="undo"], [data-cmd="redo"]')
          .prop("disabled", !1),
          (0 == this.undoStack.length || this.undoIndex <= 1 || this.isHTML) &&
            this.$bttn_wrapper.find('[data-cmd="undo"]').prop("disabled", !0),
          (this.undoIndex == this.undoStack.length || this.isHTML) &&
            this.$bttn_wrapper.find('[data-cmd="redo"]').prop("disabled", !0);
      }
    }),
    (b.prototype.refreshDefault = function (b) {
      a(b).removeClass("active"),
        1 == document.queryCommandState(a(b).data("cmd")) &&
          a(b).addClass("active");
    }),
    (b.prototype.refreshAlign = function (b) {
      ...
      "justifyLeft" == c
        ...
        : "justifyCenter" == c
        ? (c = "center")
        : "justifyFull" == c && (c = "justify"),
        c == a(d[0]).css("text-align") &&
          (a(b).parents("ul").find(".cl-bttn").removeClass("active"),
          a(b).addClass("active"),
          a(b)
            .parents(".clump-dropdown")
            .find(".cl-trigger")
            .html(a(b).html()));
    }),
    (b.prototype.refreshForeColor = function (b) {
      a(b).removeClass("active"),
        document.queryCommandValue("foreColor") == b.style.backgroundColor &&
          a(b).addClass("active");
    }),
    (b.prototype.refreshBackColor = function (b) {
      a(b).removeClass("active"),
        document.queryCommandValue("backColor") == b.style.backgroundColor &&
          a(b).addClass("active");
    }),
    (b.prototype.refreshFontSize = function (b) {
      a(b).removeClass("active"),
        parseInt(document.queryCommandValue("fontSize")) ==
          parseInt(a(b).data("val")) && a(b).addClass("active");
    }),
  ...
  (a.fn.editable = function (c) {
    ...
    if (
      (a("html").data("editable") || a("html").on("click", function () {}),
      a("html").data("editable", !0),
      "string" == typeof c)
    ) {
      var f = [];
      return (
  ...
  +(function (a) {
    ...
    function C(a, b, c) {
      ...
      (a.type = "move"),
        ...
        (a.velocityX = 0.3 * a.velocityX + (0.7 * a.deltaX) / d),
        (a.velocityY = 0.3 * a.velocityY + (0.7 * a.deltaY) / d),
        (a.pageX = b.pageX),
        (a.pageY = b.pageY);
    }
    function D(a, b, c) {
    ...
    function G(a) {
      "move" !== a.namespace &&
        "moveend" !== a.namespace &&
        (J(this, "dragstart." + a.guid + " drag." + a.guid, f, b, a.selector),
  ...
  +(function (a) {
    ...
    function c(d, e) {
      ...
      if (d.tag.isComment)
        e.allowComments &&
          (f.push("<!--"),
          f.push(d.tag.rawAttributes),
          f.push(">"),
          e.format && b(d, e, f, h - 1));
      else {
        var i =
          d.tag.render &&
          (0 == e.allowedTags.length ||
            a.inArray(d.tag.name, e.allowedTags) > -1) &&
          (0 == e.removeTags.length ||
            -1 == a.inArray(d.tag.name, e.removeTags));
        if (
          (!d.isRoot &&
            i &&
            (f.push("<"),
            f.push(d.tag.name),
            a.each(d.attributes, function () {
              if (-1 == a.inArray(this.name, e.removeAttrs)) {
                var b = RegExp(/^(['"]?)(.*?)['"]?$/).exec(this.value),
                  c = b[2],
                  g = b[1] || "'";
                "class" == this.name &&
                  e.allowedClasses.length > 0 &&
                  (c = a
                    .grep(c.split(" "), function (b) {
                      return (
                        a.grep(e.allowedClasses, function (c) {
                          return (
                            c == b ||
                            (c[0] == b &&
                              (1 == c.length ||
                                a.inArray(d.tag.name, c[1]) > -1))
                          );
                        }).length > 0
                      );
                    })
                  ...
                  null != c &&
                    (c.length > 0 ||
                      a.inArray(this.name, d.tag.requiredAttributes) > -1) &&
                    (f.push(" "),
                    f.push(this.name),
                    f.push("="),
                    f.push(g),
          ...
          if (
            ...
            (n = a.htmlClean.trim(d.children.join("")).replace(/<br>/gi, "\n")),
              f.push(n),
              (g = 0 == n.length);
          else {
            for (var n = [], p = 0; p < d.children.length; p++) {
              ...
              m(q) &&
                p > 0 &&
                r.length > 0 &&
                (j(q) || k(d.children[p - 1])) &&
                n.push(" "),
                l(q)
                  ? r.length > 0 && n.push(r)
                  : (p != d.children.length - 1 || "br" != q.tag.name) &&
                    (e.format && b(q, e, n, h), (n = n.concat(c(q, e))));
            }
            e.formatIndent--,
              n.length > 0 &&
                (e.format && "\n" != n[0] && b(d, e, f, h),
    ...
    function g(a) {
      return (
        a
          ? ((this.tag = a), (this.isRoot = !1))
          : ((this.tag = new i("root")), (this.isRoot = !0)),
        (this.attributes = []),
        (this.children = []),
          ...
          if (
            ("--" == this.name
              ? ((this.isComment = !0),
                ...
                (this.format = !0))
              : ((this.isComment = !1),
                (this.isSelfClosing = a.inArray(this.name, v) > -1),
                (this.isNonClosing = a.inArray(this.name, w) > -1),
                (this.isClosing = void 0 != c && c.length > 0),
                (this.isInline = a.inArray(this.name, p) > -1),
                (this.disallowNest = a.inArray(this.name, r) > -1),
                (this.requiredParent = t[a.inArray(this.name, t) + 1]),
                (this.allowEmpty =
                  e && a.inArray(this.name, e.allowEmpty) > -1),
                (this.toProtect = a.inArray(this.name, u) > -1),
                (this.format = a.inArray(this.name, q) > -1 || !this.isInline)),
            (this.rawAttributes = d),
            (this.requiredAttributes = y[a.inArray(this.name, y) + 1]),
            e)
          ) {
            if (
              (e.tagAttributesCache || (e.tagAttributesCache = []),
              -1 == a.inArray(this.name, e.tagAttributesCache))
            ) {
              for (
                var b = x[a.inArray(this.name, x) + 1].slice(0), f = 0;
                f < e.allowedAttributes.length;
                f++
              ) {
                var g = e.allowedAttributes[f][0];
                (1 == e.allowedAttributes[f].length ||
                  a.inArray(this.name, e.allowedAttributes[f][1]) > -1) &&
                  -1 == a.inArray(g, b) &&
                  b.push(g);
              }
              e.tagAttributesCache.push(this.name),
                e.tagAttributesCache.push(b);
            }
            this.allowedAttributes =
              e.tagAttributesCache[
                a.inArray(this.name, e.tagAttributesCache) + 1
              ];
          }
        }),
        this.init(),
    ...
    (a.fn.htmlClean = function (b) {
      return this.each(function () {
        this.value
          ? (this.value = a.htmlClean(this.value, b))
          : (this.innerHTML = a.htmlClean(this.innerHTML, b));
      });
    }),
      (a.htmlClean = function (b, f) {
        (f = a.extend({}, a.htmlClean.defaults, f)),
          (f.allowEmpty = s.concat(f.allowEmpty));
        var j,
          k = /(<(\/)?(\w+:)?([\w]+)([^>]*)>)|<!--(.*?--)>/gi,
          m = /([\w\-]+)\s*=\s*(".*?"|'.*?'|[^\s>\/]*)/gi,
          n = new g(),
        ...
        for (var q; (j = k.exec(b)); ) {
          ...
          if (t.length > 0) {
            ...
            p.children.length > 0 && l((u = p.children[p.children.length - 1]))
              ? (p.children[p.children.length - 1] = u.concat(t))
              : p.children.push(t);
          }
          if (((q = k.lastIndex), r.isClosing))
            d(o, [r.name]) && (o.pop(), (p = o[o.length - 1]));
          else {
            for (var v, w = new g(r); (v = m.exec(r.rawAttributes)); ) {
              if ("style" == v[1].toLowerCase() && f.replaceStyles)
                for (
                  var x = !r.isInline, y = 0;
                  y < f.replaceStyles.length;
                  y++
                )
                  f.replaceStyles[y][0].test(v[2]) &&
                    (x || ((r.render = !1), (x = !0)),
                    p.children.push(w),
                    o.push(w),
                    (p = w),
                    (r = new i(f.replaceStyles[y][1], "", "", f)),
                    (w = new g(r)));
              null != r.allowedAttributes &&
                (0 == r.allowedAttributes.length ||
                  a.inArray(v[1], r.allowedAttributes) > -1) &&
                w.attributes.push(new h(v[1], v[2]));
            }
            ...
            for (var z = 0; z < f.replace.length; z++)
              for (var A = 0; A < f.replace[z][0].length; A++) {
                ...
                if (
                  (B && f.replace[z][0][A] == r.name) ||
                  (!B && f.replace[z][0][A].test(j))
                ) {
            ...
            if (
              (p.isRoot ||
                (p.tag.isInline && !r.isInline
                  ? (C = e(o)) && (p = o[o.length - 1])
                  : p.tag.disallowNest && r.disallowNest && !r.requiredParent
                  ? (C = !1)
                  : r.requiredParent &&
                    (C = d(o, r.requiredParent)) &&
                    (p = o[o.length - 1])),
              C)
            )
              if ((p.children.push(w), r.toProtect))
                for (var D; (D = k.exec(b)); ) {
                  ...
                  if (E.isClosing && E.name == r.name) {
                    w.children.push(RegExp.leftContext.substring(q)),
                      (q = k.lastIndex);
                    break;
                  }
                }
      ...
      (a.htmlClean.defaults = {
        ...
        allowedAttributes: [["id"], ["class"], ["style"], ["size"], ["color"]],
        removeAttrs: [],
        allowedClasses: [],
        format: !1,
        formatIndent: 0,
      ...
      (a.htmlClean.trimStartIndex = function (b) {
        for (
          var c = 0;
          c < b.length - 1 && a.htmlClean.isWhitespace(b.charAt(c));
          c++
        );
        return c;
      }),
      ...
      (a.htmlClean.trimEndIndex = function (b) {
        for (
          var c = b.length - 1;
          c >= 0 && a.htmlClean.isWhitespace(b.charAt(c));
          c--
        );
        return c + 1;
      }),
